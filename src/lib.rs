...
#[derive(Debug)]
pub struct CloudDeckProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CloudDeckProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CloudDeck processing");
    
    let mut processor = CloudDeckProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CloudDeckProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CloudDeckProcessor::new(false);
